 ...
 */
public class ForecastSettingsActivity extends AppCompatPreferenceActivity implements Preference.OnPreferenceChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) LayoutInflater.from(this).inflate(R.layout.bc_toolbar, root, false);
